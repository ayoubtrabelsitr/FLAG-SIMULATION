...
class Ressort extends VerletSpring3D     
{
  ...
  public  Ressort(Particle particleA, Particle particleB, float Distance, float forceCoefficient) // Constructeur prenant deux particules, une distance et une force de ressort
  {
